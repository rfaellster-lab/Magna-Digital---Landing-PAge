                        ...
                        <div className="ml-10 flex items-baseline space-x-8">
                            ...
                            <MagneticWrapper>
                                <a 
                                    ...
                                    className="block bg-gold-500 hover:bg-gold-300 text-black px-6 py-2 rounded-full text-sm font-bold transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(212,175,55,0.5)]"
                                >
                                    SOLICITAR AGORA
                                </a>
                            </MagneticWrapper>
